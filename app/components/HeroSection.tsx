...
export default function HeroSection() {
    return (
        <section className="relative h-screen w-full flex items-center justify-center bg-transparent overflow-hidden px-6 md:px-12 lg:px-24">
            ...
            {/* Global Vertical Lines (Linkage) */}
            <div className="absolute left-6 md:left-12 top-0 bottom-0 w-px bg-white/5 z-0"></div>
            <div className="absolute right-6 md:right-12 top-0 bottom-0 w-px bg-white/5 z-0"></div>
